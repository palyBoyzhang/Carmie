...
NSNotificationName const CAREXQForgeButtonDidTapNotification = @"CAREXQForgeButtonDidTapNotification";

@interface CAREXQTabBar ()

@property (nonatomic, strong) UIButton *crxForgeButton;

@end

@implementation CAREXQTabBar
...
- (UIButton *)crxForgeButton {
    ...
    if (!_crxForgeButton) {
        ...
        [_crxForgeButton setImage:[CAREXQImage imageNamed:@"tab_btn"]
...
- (void)crxForgeAction {
    [[NSNotificationCenter defaultCenter] postNotificationName:CAREXQForgeButtonDidTapNotification object:nil];
}
