...
@implementation CAREXQLoopMomentCell
...
- (void)crx_buildViews {
    ...
    self.crxPhoneImageView.image = [CAREXQImage imageNamed:@"crx_board_pho"];
    ...
    UIImageView *crxCommentIconView = [[UIImageView alloc] initWithImage:[CAREXQImage imageNamed:@"crx_board_add"]];
