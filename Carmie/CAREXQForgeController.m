...
@implementation CAREXQForgeController
...
- (void)crx_buildViews {
    ...
    UIImageView *crxSectionTitleView = [[UIImageView alloc] initWithImage:[CAREXQImage imageNamed:@"crx_forge_title"]];
