...
@implementation CAREXQLoopUserCell
...
- (void)crx_buildViews {
    ...
    self.crxAvatarImageView.layer.borderColor = [UIColor colorWithWhite:1 alpha:0.18].CGColor;
    ...
    self.crxOnlineView.backgroundColor = [UIColor colorWithRed:0.32 green:0.95 blue:0.29 alpha:1];
    self.crxOnlineView.layer.cornerRadius = 5.f;
    self.crxOnlineView.layer.borderWidth = 1.5f;
    self.crxOnlineView.layer.borderColor = [UIColor colorWithRed:0x12/255.0 green:0x08/255.0 blue:0x28/255.0 alpha:1].CGColor;
    ...
    self.crxNameLabel.textColor = [UIColor colorWithWhite:1 alpha:0.84];
