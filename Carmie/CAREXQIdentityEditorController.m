//
//  CAREXQIdentityEditorController.m
//  CAREXQ
//
...
static NSString * const CAREXQIdentityNicknameKey = @"CAREXQIdentityNicknameKey";
static NSString * const CAREXQIdentityProfileKey = @"CAREXQIdentityProfileKey";
static NSString * const CAREXQIdentityAvatarDataKey = @"CAREXQIdentityAvatarDataKey";

@interface CAREXQIdentityEditorController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextViewDelegate>
...
@implementation CAREXQIdentityEditorController
...
- (void)crx_buildViews {
    ...
    self.crxAvatarImageView = [[UIImageView alloc] initWithImage:[CAREXQImage imageNamed:@"crx_harbor_logo"]];
...
- (void)crx_loadSavedProfile {
    NSString *crxSavedNickname = [[NSUserDefaults standardUserDefaults] stringForKey:CAREXQIdentityNicknameKey];
    NSString *crxSavedProfile = [[NSUserDefaults standardUserDefaults] stringForKey:CAREXQIdentityProfileKey];
    NSData *crxAvatarData = [[NSUserDefaults standardUserDefaults] objectForKey:CAREXQIdentityAvatarDataKey];
...
- (void)crxSaveTapped {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:crxNickname forKey:CAREXQIdentityNicknameKey];
    [[NSUserDefaults standardUserDefaults] setObject:crxProfile forKey:CAREXQIdentityProfileKey];
    if (crxAvatarData != nil) {
        [[NSUserDefaults standardUserDefaults] setObject:crxAvatarData forKey:CAREXQIdentityAvatarDataKey];
    }
