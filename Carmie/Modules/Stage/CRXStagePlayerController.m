...
@interface CRXStagePlayerCommentCell : UITableViewCell

- (void)crx_configureWithComment:(NSDictionary *)crxComment;

@end

@interface CRXStagePlayerCommentCell ()
...
@implementation CRXStagePlayerCommentCell
...
- (void)crx_configureWithComment:(NSDictionary *)crxComment {
    self.crxAvatarView.image = [UIImage imageNamed:crxComment[@"crxAvatarName"]] ?: [UIImage imageNamed:@"crx_head_1"];
...
@interface CRXStagePlayerController ()<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
...
@implementation CRXStagePlayerController
...
- (void)crx_setupViews {
    ...
    self.crxAvatarView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:self.crxStageItem[@"crxAvatarName"]] ?: self.crxStageItem[@"crxAvatarImage"]];
    self.crxAvatarView.contentMode = UIViewContentModeScaleAspectFill;
    self.crxAvatarView.layer.cornerRadius = 18.0;
    self.crxAvatarView.clipsToBounds = YES;
    self.crxAvatarView.translatesAutoresizingMaskIntoConstraints = NO;
...
- (void)crx_setupCommentSheet {
    ...
    [self.crxCommentTableView registerClass:CRXStagePlayerCommentCell.class forCellReuseIdentifier:@"CRXStagePlayerCommentCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    CRXStagePlayerCommentCell *crxCell = [tableView dequeueReusableCellWithIdentifier:@"CRXStagePlayerCommentCell" forIndexPath:indexPath];
