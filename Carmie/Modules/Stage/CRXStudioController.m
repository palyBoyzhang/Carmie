...
@interface CRXStudioController () <UITextViewDelegate>
...
@implementation CRXStudioController
...
- (void)crx_buildViews {
    ...
    UIImageView *crxHeroImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_stage_em"]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [crxHeroImageView.heightAnchor constraintEqualToConstant:250],
        ...
        [self.crxScrollView.topAnchor constraintEqualToAnchor:crxHeroImageView.bottomAnchor constant:-8],
