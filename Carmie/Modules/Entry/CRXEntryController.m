...
@interface CRXEntryController () <UITextFieldDelegate, UITextViewDelegate>
...
- (void)crx_setupEntryViews {
    ...
    self.crxHeaderImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_entry_bg"]];
    ...
    [self.crxBackButton setImage:[UIImage imageNamed:@"crx_harbor_back@3x"] forState:UIControlStateNormal];
    ...
    [self.crxAgreementButton setImage:[UIImage imageNamed:@"crx_entry_nor"] forState:UIControlStateNormal];
...
- (void)crxAgreementButtonTapped {
    ...
    [self.crxAgreementButton setImage:[UIImage imageNamed:crxImageName] forState:UIControlStateNormal];
    [self crx_updateLoginButtonState];
}
...
- (void)crxLoginButtonTapped {
    ...
    [self crx_showAlertWithTitle:@"Success" message:@"Login information has passed the local check."];
}
