...
@interface CRXLoopDetailController () <UIScrollViewDelegate, UITextFieldDelegate>
...
@implementation CRXLoopDetailController
...
- (void)crx_buildViews {
    ...
    UIView *crxAuthorRow = [[UIView alloc] init];
    crxAuthorRow.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addSubview:crxAuthorRow];

    UIImageView *crxAuthorAvatarView = [[UIImageView alloc] initWithImage:crxPayload[@"crxAvatar"]];
    crxAuthorAvatarView.contentMode = UIViewContentModeScaleAspectFill;
    crxAuthorAvatarView.layer.cornerRadius = 19;
    crxAuthorAvatarView.clipsToBounds = YES;
    crxAuthorAvatarView.translatesAutoresizingMaskIntoConstraints = NO;
    [crxAuthorRow addSubview:crxAuthorAvatarView];

    UILabel *crxAuthorNameLabel = [[UILabel alloc] init];
    crxAuthorNameLabel.text = crxPayload[@"crxAuthorName"];
    crxAuthorNameLabel.textColor = UIColor.whiteColor;
    crxAuthorNameLabel.font = [UIFont systemFontOfSize:19 weight:UIFontWeightBold];
    crxAuthorNameLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [crxAuthorRow addSubview:crxAuthorNameLabel];

    UILabel *crxAuthorContentLabel = [[UILabel alloc] init];
    crxAuthorContentLabel.text = crxPayload[@"crxAuthorContent"];
    crxAuthorContentLabel.textColor = [UIColor colorWithWhite:1 alpha:0.78];
    crxAuthorContentLabel.font = [UIFont systemFontOfSize:15 weight:UIFontWeightRegular];
    crxAuthorContentLabel.numberOfLines = 2;
    crxAuthorContentLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [crxAuthorRow addSubview:crxAuthorContentLabel];

    UILabel *crxTimeLabel = [[UILabel alloc] init];
    crxTimeLabel.text = @"2 minutes ago";
    ...
    [crxAuthorRow addSubview:crxTimeLabel];

    UIButton *crxHeatButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [crxHeatButton setTitle:@"12.5" forState:UIControlStateNormal];
    ...
    [crxAuthorRow addSubview:crxHeatButton];
    ...
    UIImageView *crxInputIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_board_add"]];
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [crxAuthorRow.topAnchor constraintEqualToAnchor:crxMediaCardView.bottomAnchor constant:18],
        [crxAuthorRow.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:16],
        [crxAuthorRow.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant:-16],

        [crxAuthorAvatarView.topAnchor constraintEqualToAnchor:crxAuthorRow.topAnchor],
        [crxAuthorAvatarView.leadingAnchor constraintEqualToAnchor:crxAuthorRow.leadingAnchor],
        [crxAuthorAvatarView.widthAnchor constraintEqualToConstant:38],
        [crxAuthorAvatarView.heightAnchor constraintEqualToConstant:38],

        [crxAuthorNameLabel.topAnchor constraintEqualToAnchor:crxAuthorRow.topAnchor],
        [crxAuthorNameLabel.leadingAnchor constraintEqualToAnchor:crxAuthorAvatarView.trailingAnchor constant:10],
        [crxAuthorNameLabel.trailingAnchor constraintLessThanOrEqualToAnchor:crxHeatButton.leadingAnchor constant:-12],

        [crxAuthorContentLabel.topAnchor constraintEqualToAnchor:crxAuthorNameLabel.bottomAnchor constant:3],
        [crxAuthorContentLabel.leadingAnchor constraintEqualToAnchor:crxAuthorNameLabel.leadingAnchor],
        [crxAuthorContentLabel.trailingAnchor constraintEqualToAnchor:crxAuthorRow.trailingAnchor constant:-72],

        [crxTimeLabel.topAnchor constraintEqualToAnchor:crxAuthorContentLabel.bottomAnchor constant:8],
        [crxTimeLabel.leadingAnchor constraintEqualToAnchor:crxAuthorNameLabel.leadingAnchor],
        [crxTimeLabel.bottomAnchor constraintEqualToAnchor:crxAuthorRow.bottomAnchor],

        [crxHeatButton.trailingAnchor constraintEqualToAnchor:crxAuthorRow.trailingAnchor],
...
- (NSDictionary *)crx_payload {
    UIImage *crxAvatar = self.crxMomentItem[@"crxAvatar"] ?: [UIImage imageNamed:@"crx_head_1"] ?: UIImage.new;
    ...
    UIImage *crxLeft = self.crxMomentItem[@"crxImageLeft"] ?: [UIImage imageNamed:@"crx_dy_1"] ?: UIImage.new;
    UIImage *crxRight = self.crxMomentItem[@"crxImageRight"] ?: [UIImage imageNamed:@"crx_dy_2"] ?: UIImage.new;
