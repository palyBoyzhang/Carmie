...
#import "CRXLoopUserCell.h"

static NSString * const CRXLoopUserCellID = @"CRXLoopUserCellID";

@interface CRXLoopHeaderView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation CRXLoopHeaderView
...
- (void)crx_buildViews {
    ...
    [self.crxCollectionView registerClass:CRXLoopUserCell.class forCellWithReuseIdentifier:CRXLoopUserCellID];
    [self addSubview:self.crxCollectionView];
    self.crxCollectionView.translatesAutoresizingMaskIntoConstraints = NO;
    
    UIImageView *crxSectionView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_board_show"]];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    CRXLoopUserCell *crxCell = [collectionView dequeueReusableCellWithReuseIdentifier:CRXLoopUserCellID forIndexPath:indexPath];
