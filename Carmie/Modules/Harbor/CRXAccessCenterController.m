...
static NSString * const CRXAccessCoinCountKey = @"CRXAccessCoinCountKey";
static NSString * const CRXAccessPackageCellID = @"CRXAccessPackageCellID";

@interface CRXAccessPackageCell : UICollectionViewCell
...
@implementation CRXAccessPackageCell
...
- (void)crx_buildViews {
    ...
    self.crxBadgeIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_harbor_zhs"]];
...
@interface CRXAccessCenterController () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SKProductsRequestDelegate, SKPaymentTransactionObserver>
...
@implementation CRXAccessCenterController
...
- (void)crx_setupAccessCenterViews {
    self.crxBackgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_access_bg"]];
    ...
    [self.crxBackButton setImage:[UIImage imageNamed:@"crx_harbor_back"] forState:UIControlStateNormal];
    ...
    UIImageView *crxGemImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crx_harbor_zhs"]];
    ...
    [self.crxCollectionView registerClass:CRXAccessPackageCell.class forCellWithReuseIdentifier:CRXAccessPackageCellID];
...
- (void)crx_updateBalanceLabel {
    NSInteger crxCoinCount = [[NSUserDefaults standardUserDefaults] integerForKey:CRXAccessCoinCountKey];
...
- (void)crx_finishSuccessfulPurchaseForProductID:(NSString *)crxProductID {
    ...
    NSInteger crxCurrentCount = [[NSUserDefaults standardUserDefaults] integerForKey:CRXAccessCoinCountKey];
    NSInteger crxAddedCount = [crxMatchedPackage[@"crxAmount"] integerValue];
    NSInteger crxUpdatedCount = crxCurrentCount + crxAddedCount;
    [[NSUserDefaults standardUserDefaults] setInteger:crxUpdatedCount forKey:CRXAccessCoinCountKey];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    CRXAccessPackageCell *crxCell = [collectionView dequeueReusableCellWithReuseIdentifier:CRXAccessPackageCellID forIndexPath:indexPath];
